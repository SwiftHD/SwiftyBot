...
var SwiftyLauncherVersion = 3.05;
...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            window.jQuery.get('https://raw.githubusercontent.com/Apostolique/Agar.io-bot/master/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                var myVersion = parseFloat(SwiftyLauncherVersion + 0.0000);
...
(function(d, e) {
    ...
    function drawStats(d) {
        ...
        var debugStrings = [];
        debugStrings.push("Current Bot: SwiftyBot V1");
        ...
        debugStrings.push("");
        debugStrings.push("Your Best Score is: " + ~~(sessionScore / 100));
        debugStrings.push("Your Best Time is: " + bestTime + " seconds");
        debugStrings.push("");
        ...
        if (getPlayer().length > 0) {
            ...
            debugStrings.push("Your Location: " + Math.floor(getPlayer()[0].x + offsetX) + ", " + Math.floor(getPlayer()[0].y + offsetY));
        }
